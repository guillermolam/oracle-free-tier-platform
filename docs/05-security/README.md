...
| `network-trust-boundaries.md` | mirrors the future `trust-boundaries.md` described in [`docs/03-threat-model/README.md`](../03-threat-model/README.md) once EPIC-TM-01 lands |
